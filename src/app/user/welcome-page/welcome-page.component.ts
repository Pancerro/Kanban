    ...
    trigger(
      ...
      [
        transition(
          ':enter', 
          [
            style({background:"red", height: 0, width: 0, opacity: 0,  filter:' grayscale(100%) brightness(0%)'}),
            animate('25s ease-out', 
                    style({ height: 900, width:1000, opacity: 1 ,filter:' grayscale(0%) brightness(100%)'}))
          ]
        )
